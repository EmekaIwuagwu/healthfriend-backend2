 ...
 * @access  Public
 */
router.post('/verify', validateWalletSignature, async (req, res, next) => {
  try {
 ...
 * @access  Private
 */
router.get('/me', authenticateWallet, async (req, res, next) => {
  try {
 ...
 * @access  Private
 */
router.post('/resend-verification', authenticateWallet, async (req, res, next) => {
  try {
    const user = await User.findById(req.user.id);
 ...
 * @access  Private
 */
router.post('/refresh', authenticateWallet, async (req, res, next) => {
  try {
    const user = await User.findById(req.user.id);
 ...
 * @desc    Request password reset (backup auth method)
 * @access  Public
 */
...
/**
 * @route   GET /api/auth/check-wallet
 * @desc    Check if wallet is already registered
 * @access  Public
 */
