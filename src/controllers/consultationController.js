...
class ConsultationController {
  ...
  async startAIConsultation(req, res, next) {
    try {
  ...
  // Send message to AI during consultation
  ...
  // End AI consultation
  async endAIConsultation(req, res, next) {
    try {
  ...
  async bookVideoConsultation(req, res, next) {
    try {
  ...
  // Book home visit consultation
  async bookHomeVisitConsultation(req, res, next) {
    try {
      const { 
        doctorId, 
        symptoms, 
  ...
  async getConsultationDetails(req, res, next) {
    try {
  ...
  async acceptConsultation(req, res, next) {
    try {
      const consultation = await Consultation.findOne({
        _id: req.params.id,
        doctor: req.user.id,
  ...
  // Decline consultation request (Doctor only)
  async declineConsultation(req, res, next) {
    try {
  ...
  // Add/update vital signs (Doctor only)
  ...
  // Rate consultation
  async rateConsultation(req, res, next) {
    try {
